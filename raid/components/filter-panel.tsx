      ...
      case "services":
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="maxPrice">Max Price (DZD)</Label>
              <Input
                id="maxPrice"
                type="number"
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => updateFilter("fromCity", v)}
              >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => updateFilter("toCity", v)}
              >
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => updateFilter("lostFoundType", v)}
              >
